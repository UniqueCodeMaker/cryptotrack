...
import type { TransactionDTO as _TransactionDTO, TransactionId as _TransactionId, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addHolding(arg0: string, arg1: string, arg2: number, arg3: number, arg4: string): Promise<HoldingId> {
        if (this.processError) {
            try {
                const result = await this.actor.addHolding(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addTransaction(arg0: string, arg1: Variant_buy_sell, arg2: number, arg3: number, arg4: number, arg5: string): Promise<TransactionId> {
        if (this.processError) {
            try {
                const result = await this.actor.addTransaction(arg0, to_candid_variant_n1(this._uploadFile, this._downloadFile, arg1), arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteTransaction(arg0: TransactionId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getReferralLeaderboard(): Promise<Array<ReferralLeaderboardEntry>> {
        if (this.processError) {
            try {
    ...
    async getUserHoldings(arg0: UserId): Promise<Array<HoldingDTO>> {
        if (this.processError) {
            try {
    ...
    async getUserTransactions(arg0: UserId): Promise<Array<TransactionDTO>> {
        if (this.processError) {
            try {
    ...
    async removeHolding(arg0: HoldingId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeHolding(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateHolding(arg0: HoldingId, arg1: string, arg2: string, arg3: number, arg4: number, arg5: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateHolding(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_TransactionDTO_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TransactionDTO): TransactionDTO {
...
function from_candid_vec_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_TransactionDTO>): Array<TransactionDTO> {
    return value.map((x)=>from_candid_TransactionDTO_n8(_uploadFile, _downloadFile, x));
}
...
function to_candid_variant_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_buy_sell): {
    buy: null;
} | {
    sell: null;
} {
